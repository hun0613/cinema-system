  ...
  return (
    ...
    >
      <div
        ...
        className={
          renderState
            ? `flex h-fit w-[90%] max-w-[800px] translate-y-0 flex-col items-center justify-center rounded-xl bg-white/90 p-5 opacity-100 drop-shadow-xl duration-500 ease-in-out tablet:w-2/3 tablet:p-10`
            : `flex h-fit w-[90%] max-w-[800px] translate-y-10 flex-col items-center justify-center rounded-xl bg-white/90 p-5 opacity-0 drop-shadow-xl tablet:w-2/3 tablet:p-10`
        }
      >
        {children}
      </div>
